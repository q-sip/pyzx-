"""
Docstring for pyzx_db_addon.graph_neo4j
"""
...
class GraphNeo4j(BaseGraph[VT, ET]):
    ...
    def __init__(
        ...
        self.uri = uri or os.getenv("DB_URI_NEO4J") or os.getenv("DB_URI")
        self.user = user or os.getenv("DB_USER_NEO4J") or "neo4j"
        self.password = password or os.getenv("DB_PASSWORD_NEO4J") or os.getenv("DB_PASSWORD")
