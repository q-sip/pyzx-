...
class ZXdbAge:
    ...
    def turn_hadamard_gates_into_edges(self) -> None:
        """Convert degree-2 Hadamard H-boxes into Hadamard edges."""
        ...
        if total:
            print(f"Turn Hadamard gates into edges(age): Processed {total} patterns.")
        else:
            print("Turn Hadamard gates into edges(age): Processed 0 patterns.")
