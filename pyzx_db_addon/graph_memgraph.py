...
class GraphMemgraph(BaseGraph[VT, ET]):
    ...
    def __init__(
        ...
        self.uri = uri or os.getenv("MEMGRAPH_URI") or os.getenv("DB_URI_MEMGRAPH")
        self.user = user or os.getenv("DB_USER_MEMGRAPH") or os.getenv("DB_USER")
        self.password = password or os.getenv("DB_PASSWORD_MEMGRAPH") or os.getenv("DB_PASSWORD")
