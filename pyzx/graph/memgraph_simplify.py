...
- :func:`interior_clifford_simp_db`: Interior clifford simplifications
...
def interior_clifford_simp_db(
    ...
    """
    if not quiet:
        print("Starting interior_clifford_simp_db...")
    ...
    while True:
        ...
        i1 = spider_simp_db(session_factory, graph_id, quiet, stats)
    ...
    if not quiet:
        print(f"Completed interior_clifford_simp_db after {iteration} iterations")
...
def clifford_simp_db(
    ...
    while True:
        i1 = interior_clifford_simp_db(session_factory, graph_id, quiet, stats)
...
def full_reduce_db(
    ...
    interior_clifford_simp_db(session_factory, graph_id, quiet, stats)
